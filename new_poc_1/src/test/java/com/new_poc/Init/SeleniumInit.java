...
import com.new_poc.Init.TestData;
import com.new_poc.Page.DashboardPage;
import com.new_poc.pages.Indexpage.CreateNewNetworkDiscovery_IndexPage;
import com.new_poc.pages.Indexpage.login_IndexPage;
...
public class SeleniumInit implements ILoggerStatus {
	...
	protected CreateNewNetworkDiscovery_IndexPage createNetwork_indexpage;
    protected login_IndexPage login_page;
	...
	public void setUp(Method method) throws IOException, InterruptedException {
		...
		createNetwork_indexpage = new CreateNewNetworkDiscovery_IndexPage(driver);
		login_page	= new login_IndexPage(driver);
